...
SET GLOBAL RELAY_LOG_INFO_REPOSITORY='TALBE';
~~~
...
*************************** 1. row ***************************
               Slave_IO_State: Queueing master event to the relay log
                ...
                Connect_Retry: 60
              Master_Log_File: mysql-bin.000001
          Read_Master_Log_Pos: 191568428
               Relay_Log_File: mysql-relay-bin.000005
                Relay_Log_Pos: 106989956
        Relay_Master_Log_File: mysql-bin.000001
             Slave_IO_Running: Yes
            Slave_SQL_Running: Yes
              Replicate_Do_DB: 
  ...
  Replicate_Wild_Ignore_Table: 
                   ...
                   Last_Error: 
                 Skip_Counter: 0
          Exec_Master_Log_Pos: 188536193
              Relay_Log_Space: 110022564
              Until_Condition: None
               Until_Log_File: 
                Until_Log_Pos: 0
           Master_SSL_Allowed: No
...
```
[root@sql2 mysql]# mysqlbinlog mysql-relay-bin.000005 --start-position=106989956 -f
/*!50530 SET @@SESSION.PSEUDO_SLAVE_MODE=1*/;
/*!40019 SET @@session.max_insert_delayed_threads=0*/;
/*!50003 SET @OLD_COMPLETION_TYPE=@@COMPLETION_TYPE,COMPLETION_TYPE=0*/;
DELIMITER /*!*/;
# at 4
#210127 13:54:50 server id 164185  end_log_pos 123 CRC32 0x8bb1c0ec 	Start: binlog v 4, server v 5.7.32-log created 210127 13:54:50
BINLOG '
Og4RYA9ZgQIAdwAAAHsAAABAAAQANS43LjMyLWxvZwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
AAAAAAAAAAAAAAAAAAAAAAAAEzgNAAgAEgAEBAQEEgAAXwAEGggAAAAICAgCAAAACgoKKioAEjQA
AezAsYs=
'/*!*/;
# at 106989956
#210106 16:18:45 server id 164186  end_log_pos 188536258 
# Unknown event
# at 106990021
#210127 17:15:19 server id 164185  end_log_pos 106990074 CRC32 0x90178e5f 	Rotate to mysql-relay-bin.000006  pos: 4
DELIMITER ;
# End of log file
...
```
sh -c 'mysqldump -u root -pX78@Tg@9.h --single-transaction --all-databases | mysql -h 10.1.254.44 -P 9600 -u root -pX78@Tg@9.h  &'
```
